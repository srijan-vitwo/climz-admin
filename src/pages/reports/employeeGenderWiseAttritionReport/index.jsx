...
const EmpGenderWiseAttritionReportView = () => {
  ...
  useEffect(() => {
    fetch(
      `http://consoledev.claimz.in/admin-api/api/auth/attrition-gender/${date1stValue}/${date2ndValue}`,
      {
        headers: {
  ...
  return (
    <Card>
      ...
      <Tabs>
        ...
        <TabPanels>
          <TabPanel>
            <EmpGenderWiseAttritionReportGraph graphData={listValue} />
          </TabPanel>
          <TabPanel>
            <EmpGenderWiseAttritionReportTable dataList={listValue} />
          </TabPanel>
        </TabPanels>
      </Tabs>
    </Card>
