...
`
const EmpJoiningDateWiseDiversityReportTable = ({ dataList }) => {
    ...
    const cols = [
        { field: 'age_group', header: 'Company Experience (in years)' },
        { field: 'COUNT(*)', header: 'No. of Employee' },
    ];
    ...
    return (
        <CssWrapper >
            <Box className="card">
                <DataTable value={dataList} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="age_group" >
                    {cols.map((col, index) => (
...
export default EmpJoiningDateWiseDiversityReportTable