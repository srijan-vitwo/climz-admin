...
function EmpJoiningDateWiseDiversityReportGraph({graphData}) {
  ...
  useLayoutEffect(() => {
    ...
    series.tooltipText = "{categoryX} years : [bold]{valueY}[/]";
...
export default EmpJoiningDateWiseDiversityReportGraph