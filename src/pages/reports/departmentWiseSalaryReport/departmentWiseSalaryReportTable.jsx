...
`
const DepartmentWiseSalaryReportTable = ({ dataList }) => {
    ...
    return (
        <CssWrapper >
            <Box className="card">
                <DataTable value={dataList} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="department_id" >
                    {cols.map((col, index) => (
...
export default DepartmentWiseSalaryReportTable