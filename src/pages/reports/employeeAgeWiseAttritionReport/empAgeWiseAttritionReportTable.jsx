...
`
const EmpAgeWiseAttritionReportTable = ({ dataList }) => {
    ...
    const cols = [
        { field: 'age_group', header: 'Age' },
        { field: 'total_monthly_ctc', header: 'Total Monthly CTC' },
        { field: 'total_attrition', header: 'No. of Attrition' },
    ];
...
export default EmpAgeWiseAttritionReportTable