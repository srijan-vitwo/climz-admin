...
import MonthWiseAttritionReportGraph from "./monthWiseAttritionReportGraph";
import MonthWiseAttritionReportTable from "./monthWiseAttritionReportTable";

const MonthWiseAttritionReportView = () => {
  ...
  useEffect(() => {
    fetch(
      `http://consoledev.claimz.in/admin-api/api/auth/attrition-month/${date1stValue}/${date2ndValue}`,
      {
        headers: {
  ...
  return (
    <Card>
      ...
      <Tabs>
        ...
        <TabPanels>
          <TabPanel>
            <MonthWiseAttritionReportGraph graphData={listValue} />
          </TabPanel>
          <TabPanel>
            <MonthWiseAttritionReportTable dataList={listValue} />
          </TabPanel>
        </TabPanels>
      </Tabs>
    </Card>
...
export default MonthWiseAttritionReportView;
