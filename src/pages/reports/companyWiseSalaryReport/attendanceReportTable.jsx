...
const AttendanceReportTable = ({ dataList }) => {
    ...
    const cols = [
        ...
        { field: 'attendance_status', header: 'Attendance Status' },
    ];
    ...
    return (
        <CssWrapper >
            <Box className="card">
                <DataTable value={dataList} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="user_id" >
                    {cols.map((col, index) => (
