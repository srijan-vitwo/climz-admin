...
const EmpGenderWiseDiversityReportView = () => {
    ...
    useEffect(() => {
        fetch(`http://consoledev.claimz.in/admin-api/api/auth/diversity-gender`, {
            headers: {
    ...
    return (
        <Card>
            ...
            <Tabs>
                ...
                <TabPanels>
                    <TabPanel>
                        <EmpGenderWiseDiversityReportGraph graphData={listValue} />
                    </TabPanel>
                    <TabPanel>
                        <EmpGenderWiseDiversityReportTable dataList={listValue} />
                    </TabPanel>
                </TabPanels>
            </Tabs>
        </Card>
