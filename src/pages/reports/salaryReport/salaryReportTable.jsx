...
const SalaryReportTable = ({ dataList }) => {
                        ...
                        <DrawerHeader pt='28px'>
                            <Box
                                ...
                                <Text background='linear-gradient(180deg, #2770AE 0%, #01325B 100%)'
                                    ...
                                    fontWeight='700'
                                    fontSize='28px'
                                    lineHeight='36px'>Employee List Details</Text>
                            </Box >
                        </DrawerHeader>
                        ...
                        <DrawerBody>
                            <Box position='fixed'>
                                <Button bg='none' _hover={{ bg: 'none' }}
                                    _active={{ bg: 'none' }}
                                    _focus={{ bg: 'none' }} border='2px solid var(--chakra-colors-claimzBorderColor)' borderRadius='15px' height='45px' padding='0px 20px' mr='10px'>
                                    <Text background='linear-gradient(180deg, #2770AE 0%, #01325B 100%)'
                                        backgroundClip='text'
                                        fontSize='1.6rem' fontWeight='700'>
                                        Edit
    ...
    return (
        <CssWrapper >
            <Box className="card">
                <DataTable value={dataList} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="id" >
                    {cols.map((col, index) => (
                        <Column key={index} field={col.field} header={col.header} />
                    ))}
                    <Column header="Action" body={ActionTemplate} bodyStyle={{ textAlign: 'center' }} />
                </DataTable>
                {/* pegination */}
