...
`
const EmpGroupWiseDiversityReportTable = ({ dataList }) => {
    ...
    const cols = [
        ...
        { field: 'COUNT(designation.designation_name)', header: 'No. of Employee' },
    ];
    ...
    return (
        <CssWrapper >
            <Box className="card">
                <DataTable value={dataList} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="designation_name" >
                    {cols.map((col, index) => (
...
export default EmpGroupWiseDiversityReportTable