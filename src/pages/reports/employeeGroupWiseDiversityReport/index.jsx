...
const EmpGroupWiseDiversityReportView = () => {
    ...
    useEffect(() => {
        fetch(`http://consoledev.claimz.in/admin-api/api/auth/diversity-designation`, {
            headers: {
    ...
    return (
        <Card>
            ...
            <Tabs>
                ...
                <TabPanels>
                    <TabPanel>
                        <EmpGroupWiseDiversityReportGraph graphData={listValue} />
                    </TabPanel>
                    <TabPanel>
                        <EmpGroupWiseDiversityReportTable dataList={listValue} />
                    </TabPanel>
                </TabPanels>
            </Tabs>
        </Card>
