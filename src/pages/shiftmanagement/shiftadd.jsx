    ...
    return (
        <Box>
            ...
            >
                ...
                <Box>
                    <form onSubmit={shiftAdd} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                        <Box w='100%'>
                            <FormControl mb='15px'>
                                <FormLabel> Shift Name</FormLabel>
                                <Input type='text' onChange={e => setShiftName(e.target.value)} required />
                            </FormControl>
                        </Box>
                        ...
                        <Box w='100%' mt='20px'>
                            ...
                            >
                                ...
                                >
                                    <Text mr='10px' fontWeight="700">Add Others Day</Text>
                                        ...
                                        <Box display='flex' justifyContent='space-between' mb='15px'>
                                            ...
                                            <FormControl width='19%'>
                                                ...
                                                <Input type='time' name='in_time' value={field.in_time}
                                                    onChange={(event) => handleChange(index, event)} required />
                                            </FormControl>
                                            <FormControl width='19%'>
                                            ...
                                            <FormControl width='19%'>
                                                ...
                                                >
                                                    ...
                                                    {!flag ?
                                                        <Text mr='10px'>More <i className="fa-solid fa-plus"></i></Text>
                                                        :
                                                        <Text mr='10px'>Less <i className="fa-solid fa-minus"></i></Text>
                                                    }
                                                </Button>
                                            </FormControl>
                                        </Box>
