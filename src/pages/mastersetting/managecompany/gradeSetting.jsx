...
const GradeSetting = () => {
    ...
    const empListAdd = async (e) => {
        ...
        try {
            setIsLoading(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/grade-post`, {
                method: "POST",
                body: formData,
                headers: {
            ...
            <Box display='flex' justifyContent='space-between' mt='30px'>
                ...
                >
                    ...
                    >
                        ...
                        <Box as="span" ml='15px'>Employee Grade</Box>
                    </Heading>
                    <Box>
            ...
            <ButtonGroup w="100%" >
                <Flex w="100%" justifyContent="space-between">
                    ...
                    <Button
                        ...
                        _active={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        _focus={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        onClick={() => navigate("/master-setting/manage-company/designation-setting")}
                    >
                        Next
                    </Button>
