...
const GradeSettingDataTable = ({ Msg }) => {
    ...
    const ActionTemplate = (rowData) => {
        ...
        const tierUpdate = async (e) => {
            ...
            try {
                setIsLoading(true)
                const response = await fetch(`${process.env.REACT_APP_API_URL}/grade-update`, {
                    method: "POST",
                    body: formData,
                    headers: {
                        Authorization: `Bearer ${token}`,
            ...
            >
                ...
                <div className="card p-fluid">
                    <DataTable value={products} editMode="row" dataKey="id" tableStyle={{ minWidth: '50rem' }}>
                        <Column field="grade_value" header="Grade Value" bodyStyle={{ textAlign: 'center' }} style={{ width: '25%' }}></Column>
