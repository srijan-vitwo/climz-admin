...
const CompanyProfile = ({ companyData }) => {
    ...
    const [companyAddress, setCompanyAddress] = useState(companyData.company_address)
    ...
    const UpdateCompanyProfile = async (e) => {
        ...
        try {
            setIsLoading(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/company-update`, {
                method: "POST",
                body: formData,
                headers: {
                ...
                <Box position='relative'>
                    ...
                    >
                        ...
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Company Profile</Box>
                    </Box>
                    ...
                    >
                        ...
                        >3</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Department Settings
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        >5</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Grade Settings</Box>
                    </Box>
                    ...
                    >
                        ...
                        >6</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Designation Settings</Box>
                    </Box>
                </Box>
            </Box>
            ...
            <form onSubmit={UpdateCompanyProfile}>
                <Box height='333px'>
                    ...
                    >
                        <FormControl w='31%'>
                            <FormLabel >
                                Company Name <Box as='span' color='orange'>*</Box>
                            </FormLabel>
                            <Input className={editable ? 'editable' : 'disabled'} type='text' placeholder="Company Name" value={companyName}
                                onChange={e => setCompanyName(e.target.value)} />
                        </FormControl>

                        <FormControl w='31%'>
                            <FormLabel>
                                Company Address <Box as='span' color='orange'>*</Box>
                            </FormLabel>
                            <Input className={editable ? 'editable' : 'disabled'} type='text' placeholder="Company Address " value={companyAddress}
                        ...
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='email' placeholder="Company Email" value={companyEmail}
                    ...
                    <Box display='flex' flexWrap='wrap' justifyContent='space-between' mb='20px'>
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='tel' placeholder="Company Phone" value={companyPhone}
                        ...
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='text' placeholder="Company Brand" value={companyBrand}
                    ...
                    <Box display='flex' flexWrap='wrap' justifyContent='space-between' mb='20px'>
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='url' placeholder="Company Website" value={companyWebsite}
                        ...
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='text' placeholder="Company PNR Number" value={companyPan}
                        ...
                        <FormControl w='31%'>
                            ...
                            <Input className={editable ? 'editable' : 'disabled'} type='text' placeholder="Company GST" value={companyGstn}
                ...
                <ButtonGroup w="100%">
                    <Flex w="100%" justifyContent="space-between">
                        ...
                        <Button
                            ...
                            _active={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                            _focus={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                            onClick={() => navigate("/master-setting/manage-company/employee-code")}
                        >
                            Next
                        </Button>
