      ...
      <Box display='flex' justifyContent='space-between' alignItems='center'>
        ...
        <Box>
          ...
          <Button
            ...
            _active={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
            _focus={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
            onClick={() => navigate("/master-setting/add-new-travel-master")}
          >
            Add New
          </Button>
      ...
      <Box className="card p-fluid">
        {loader ?
          ...
          <DataTable value={products} header={header} filters={filters} onFilter={(e) => setFilters(e.filters)} dataKey="id" tableStyle={{ minWidth: '50rem' }}>
            <Column field="name" header="Mode" sortable bodyStyle={{ textAlign: 'center' }} style={{ width: '33%' }}></Column>
            <Column field="type" header="Type" sortable bodyStyle={{ textAlign: 'center' }} style={{ width: '33%' }}></Column>
            <Column header="Action" body={ActionTemplate} bodyStyle={{ textAlign: 'center' }} style={{ width: '33%' }} />
          </DataTable>
        }
      </Box>
