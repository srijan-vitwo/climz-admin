  ...
  useEffect(() => {
    const travelLimit = async () => {
      try {
        ...
        const response2 = await fetch(`${process.env.REACT_APP_API_URL}/travel-accomodation`, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
          },
        ...
        if (response1.ok && response2.ok) {
          ...
          setTravelLimit(tableInputData.data.accomodation_limit);
  ...
  return (
    <Box>
      ...
      <Box bg='white' borderRadius='15px' mb='30px'>
        <Heading mb='15px' color='claimzTextBlueColor'> List of all Accomodation Limits</Heading>
        {loader ?
