...
const LeavePolicies = () => {
    ...
    useEffect(() => {
        const leavepolicies = async () => {
            setLoader(true)
            try {
                const response1 = await fetch(`${process.env.REACT_APP_API_URL}/leave-system-create`, {
                    method: "GET",
                    headers: {
                ...
                if (response1.ok) {
                    ...
                    if (response.calender_type) {
                        if (response.calender_type.cal_type) {
                            ...
                            setYearLastDayCalender(response.calender_type.cal_end_month)
                            setYearFirstDayCalender(response.calender_type.cal_start_month)
                        } else {
                            setIsSelected("calender");
                        }
                    } else {
    ...
    const leavetypeAdd = async (e) => {
        ...
        try {
            setIsLoading(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/leave-type`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const yearTypeAddCalender = async (e) => {
        ...
        try {
            setIsLoading1(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/calender-type`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const ruleTypeOne = async (e) => {
        ...
        try {
            setIsLoading3(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/rule-type`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const ruleTypeIncrement = async (e) => {
        ...
        try {
            setIsLoading4(true)
            const response1 = await fetch(`${process.env.REACT_APP_API_URL}/rule-type`, {
                method: "POST",
                body: formDataType,
                headers: {
                    Authorization: `Bearer ${token}`,
            ...
            const response2 = await fetch(`${process.env.REACT_APP_API_URL}/increment-type`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const ruleTypeSandwitch = async (e) => {
        ...
        try {
            setIsLoading5(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/sandwich-update`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
                ...
                <Box position='relative'>
                    ...
                    >
                        <Box
                            ...
                            alignItems='center'
                        >1</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Week-Off Variant
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        >2</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Leave Policies
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        >3</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Holiday Policies
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        >4</Box>
                        <Box as='span' color='claimzTextBlackColor' fontWeight='600'
                            fontSize='1.5rem'>Track Management
                        </Box>
                    </Box>
                </Box>
            </Box>
            ...
            <Box>
                        ...
                        <Box
                            ...
                            <Box w='100%' display='flex' gap='15px' mb='15px'>
                                <FormControl w='100%'>
                                    ...
                                    <Input type="text" placeholder="Enter leave Type" value={leaveType} onChange={e => setLeaveType(e.target.value)} required />
                                </FormControl>
                                <FormControl w='100%'>
                                    <FormLabel >Total Leave</FormLabel>
                                    <Input type="text" placeholder="Enter Total Leave" value={totalLeave} onChange={e => setTotalLeave(e.target.value)} required />
                                </FormControl>
                            </Box>
                            <Box w='100%' display='flex' gap='15px'>
                                <FormControl w='100%'>
                                    <FormLabel >Carry Forword</FormLabel>
                                    <Input type="text" placeholder="Enter Carry Forword" value={carryForword} onChange={e => setCarryForword(e.target.value)} required />
                                </FormControl>
                                <FormControl w='100%'>
                                    <FormLabel >Encashment</FormLabel>
                                    <Input type="text" placeholder="Enter Encashment" value={encashment} onChange={e => setEncashment(e.target.value)} required />
                                </FormControl>
                            </Box>
                            <Button
                                disabled={isLoading}
                            ...
                            >
                                <i className="fa-sharp fa-solid fa-plus"></i> <Box as="span" ml='5px'>Add Leave Type</Box>
                            </Button>
                        </Box>
                    </form>
                    <Box
                        ...
                        pb='10px'
                    >
                        <LeavepolicyDataTable leaveList={leaveList} Loader={loader} msg={msg} setMsg={setMsg} />
                    </Box>
                </Box>
                {/* Leave type End */}
                ...
                <Box>
                    ...
                    >
                            ...
                            <Stack direction='row' gap='20px'>
                                ...
                                >
                                    <Box fontSize='1.4rem'
                                        ...
                                        color='claimzTextBlueLightColor'>Calender Year
                                    </Box>
                                </Radio>
                                <Radio
                                    value='financial'
                                ...
                                >
                                    <Box fontSize='1.4rem'
                                        fontWeight='700'
                                        textTransform='capitalize'
                                        color='claimzTextBlueLightColor'>Financial Year
                                    </Box>
                                </Radio>
                            </Stack>
                        </RadioGroup>
                        ...
                        >
                            {isSelected === 'calender' ?
                                <form style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'end' }} onSubmit={yearTypeAddCalender}>
                                    <Box w='100%' display='flex' gap='15px' mb='15px'>

                                        <FormControl w='100%'>
                                            <FormLabel >Year Start Date1</FormLabel>
                                            <Input type="date" value={yearFirstDayString} placeholder="Enter leave Type" />
                                        </FormControl>
                                        <FormControl w='100%'>
                                            <FormLabel >Year End Date</FormLabel>
                                            <Input type="date" value={yearLastDayString} placeholder="Enter Total Leave" />
                                        </FormControl>
                                    ...
                                    <Button
                                        ...
                                        type='submit'
                                    >
                                        <Box as="span" ml='5px'>Submit</Box>
                                    </Button>
                                </form>
                                :
                                <form style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'end' }} onSubmit={yearTypeAddFinancial}>
                                    <Box w='100%' display='flex' gap='15px' mb='15px'>
                                        <FormControl w='100%'>
                                            <FormLabel >Year Start Date</FormLabel>
                                            <Input type="date" value={yearFirstDayCalender} onChange={handleInputChangeFirst} placeholder="Enter leave Type" />
                                        </FormControl>
                                        <FormControl w='100%'>
                                            <FormLabel >Year End Date</FormLabel>
                                            <Input type="date" value={yearLastDayCalender} onChange={handleInputChangeLast} placeholder="Enter Total Leave" />
                                        </FormControl>
                                    </Box>
                                    <Button
                                        disabled={isLoading2}
                    ...
                    <Box>
                        ...
                        >
                            ...
                            <form onSubmit={ruleTypeOne}>
                                <RadioGroup onChange={setIsSelectedOne} value={isSelectedOne}>
                                    <Stack direction='row' gap='20px'>
                                        <Radio
                                            value='one'
                                            size='lg'
                                        ...
                                        >
                                            <Box fontSize='1.4rem'
                                                fontWeight='700'
                                                textTransform='capitalize'
                                                color='claimzTextBlueLightColor'>One Time
                                            </Box>
                                        </Radio>
                                        <Radio
                                            value='increment'
                                        ...
                                        >
                                            <Box fontSize='1.4rem'
                                                fontWeight='700'
                                                textTransform='capitalize'
                                                color='claimzTextBlueLightColor'>Incremental
                                            </Box>
                                        </Radio>
                                    </Stack>
                                </RadioGroup>
                            ...
                            {isSelectedOne === 'increment' &&
                                <Box
                                    ...
                                    mt='15px'
                                >
                                    <form onSubmit={ruleTypeIncrement} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'end' }} id="increment">
                                        {(leaveList.increment ? leaveList.increment : leaveList.leave_types)?.map((data, index) => {
                                            let start_date = isSelected === 'calender' ? `${yearFirstDayString}` : `${yearFirstDay}`;
                                            let end_date = isSelected === 'calender' ? `${yearLastDayString}` : `${yearLastDay}`;

                                            incrementFormData[index] = { id: data.leave_type_id, val: "", start: start_date, end: end_date };

                                            return (
                                                <Box key={index} w='100%' display='flex' gap='15px' mb='15px'>
                                                    <FormControl w='100%'>
                                                        <FormLabel >{data.leave_types}</FormLabel>
                                                        <Input type="text" value={data.leave_types} placeholder="Enter Sick Leave" />
                                                    </FormControl>
                                                    <FormControl w='100%'>
                                                    ...
                                                    <FormControl w='100%'>
                                                        ...
                                                        <Input type="date" value={start_date} onChange={e => changeIncrementFormData(index, "start", e.target.value)} placeholder="Enter Date" />
                                                    </FormControl>
                                                    <FormControl w='100%'>
                                                        <FormLabel >End Date</FormLabel>
                                                        <Input type="date" value={end_date} onChange={e => changeIncrementFormData(index, "end", e.target.value)} placeholder="Enter Date" />
                                                    </FormControl>
                                                </Box>
                                            )
                                        })}
                    ...
                    <Box>
                        ...
                        >
                            ...
                            <form onSubmit={ruleTypeSandwitch} value={isSelectedSandwitch}>
                                    ...
                                    <Stack direction='row' gap='20px'>
                                        ...
                                        >
                                            <Box fontSize='1.4rem'
                                                fontWeight='700'
                                                textTransform='capitalize'
                                                color='claimzTextBlueLightColor'>Apply Sandwich Rule
                                            </Box>
                                        </Radio>
                                        <Radio
                                            value='0'
                                            size='lg'
                                            onChange={handleSelectionSkipSandwitch}
                                        >
                                            <Box fontSize='1.4rem'
                                                fontWeight='700'
                                                textTransform='capitalize'
                                                color='claimzTextBlueLightColor'> Skip Sandwich Rule
                                            </Box>
                                        </Radio>
                                    </Stack>
                                </RadioGroup>
            ...
            <ButtonGroup w="100%">
                <Flex w="100%" justifyContent="space-between">
                    <Button
                        ...
                        _active={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        _focus={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        onClick={() => customNavigate("/master-setting/attendance-settings/week-of-variant")}
                    ...
                    <Button
                        ...
                        _active={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        _focus={{ bgGradient: 'linear(180deg, #2267A2 0%, #0D4675 100%)' }}
                        onClick={() => customNavigate("/master-setting/attendance-settings/holiday-policies")}
                    >
                        Next
                    </Button>
