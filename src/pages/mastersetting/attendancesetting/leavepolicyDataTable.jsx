                    ...
                    <DrawerContent maxW='40% !important' bgGradient='linear(180deg, #DCF9FF 0%, #FFFFFF 100%)'>
                        ...
                        <DrawerBody>
                            <Box display='flex' flexDirection='column' alignItems='end'>
                                <form style={{ width: '100%', display: 'flex', alignItems: 'end', flexDirection: 'column' }} onSubmit={updateVariant}>
                                    <Box width='100%'>
                                        <Box w='100%' display='flex' gap='15px' mb='15px'>
                                            ...
                                            <FormControl w='100%'>
                                                ...
                                                <Input type="text" placeholder="Enter Total Leave" value={total} onChange={e => setTotal(e.target.value)} required />
                                            </FormControl>
                                        </Box>
                                        <Box w='100%' display='flex' gap='15px'>
                                            <FormControl w='100%'>
                                                <FormLabel >Carry Forword</FormLabel>
                                                <Input type="text" placeholder="Enter Carry Forword" value={carry} onChange={e => setCarry(e.target.value)} required />
                                            </FormControl>
                                            <FormControl w='100%'>
                                                <FormLabel >Encashment</FormLabel>
                                                <Input type="text" placeholder="Enter Encashment" value={encash} onChange={e => setEncash(e.target.value)} required />
                                            </FormControl>
                                        </Box>
                                    </Box>
        ...
        <CssWrapper>
            {Loader ?
                ...
                <div className="card p-fluid">
                    <DataTable value={leaveList.leave_types} dataKey="leave_type_id" tableStyle={{ minWidth: '50rem' }}>
                        <Column field="leave_types" header="Leave Types" bodyStyle={{ textAlign: 'center' }} style={{ width: '25%' }}></Column>
                        <Column field="number" header="Total Leave" bodyStyle={{ textAlign: 'center' }} style={{ width: '25%' }}></Column>
                        <Column field="carryforward" header="Carry Forward" bodyStyle={{ textAlign: 'center' }} style={{ width: '25%' }}></Column>
                        <Column field="encashment" header="Encashment" bodyStyle={{ textAlign: 'center' }} style={{ width: '25%' }}></Column>
