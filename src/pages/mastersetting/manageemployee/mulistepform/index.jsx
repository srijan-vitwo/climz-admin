...
const MultiStepForm = () => {
    ...
    const fromDataAdd = async () => {
        ...
        try {
            setIsLoading(true)
            const response = await fetch(`${process.env.REACT_APP_API_URL}/employee-post`, {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    console.log(formData?.employee_code_prefix, "formData?.employee_code_prefix")
            ...
            {loader ?
                ...
                <Box className="form">
                    ...
                    <Box className="form-container">
                        <Box className="body" minH='470px'>{PageDisplay()}</Box>
