    ...
    return (
        <>
            <Heading w="100%" fontWeight="600" mb="2%" color='claimzTextBlueColor'>
                <Box as='span' pr='15px'><i className="fa-solid fa-building"></i></Box> KYC Details
            </Heading>
            <Box display='flex'
                flexWrap='wrap'
            ...
            >
                <FormControl w='31%'>
                    <FormLabel >
                        PAN <Box as='span' color='orange'>*</Box>
                    </FormLabel>
                ...
                <FormControl w='31%'>
                    <FormLabel>
                        Mobile No <Box as='span' color='orange'
                        >*</Box>
                    </FormLabel>
                    <Input type='number' placeholder='Mobile No'
                        value={formData.mobile_no}
                        onChange={(event) =>
                            setFormData({ ...formData, mobile_no: event.target.value })
                        } />
                </FormControl>
            ...
            <Box display='flex' flexWrap='wrap' justifyContent='space-between' mb='20px'>
                <FormControl w='31%'>
                    ...
                    <Input type='email' placeholder='Mail ID'
                        ...
                        onChange={(event) =>
                            setFormData({ ...formData, mail_id: event.target.value })
                        } />
                </FormControl>
                ...
                <FormControl w='31%'>
                    ...
                    <Input type='Text' placeholder="Emergency Cont No"
                        value={formData.emergency_cont_no}
                        onChange={(event) =>
                            setFormData({ ...formData, emergency_cont_no: event.target.value })
                        } />
                </FormControl>
