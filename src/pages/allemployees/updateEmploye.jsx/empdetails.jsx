...
const EmpDetails = ({ formData, setFormData, fromValue, costCenter, empCode }) => {
    ...
    return (
        <>
            ...
            <Box display='flex' flexWrap='wrap' justifyContent='space-between' mb='20px'>
                ...
                <FormControl w='31%'>
                    ...
                    <Input type='date'
                        ...
                        onChange={(event) =>
                            setFormData({ ...formData, leave_date: event.target.value })
                        } />
                </FormControl>
            ...
            <Box display='flex' flexWrap='wrap' justifyContent='space-between' mb='20px'>
                ...
                <FormControl w='31%'>
                    ...
                    <Select placeholder='Select option'
                        ...
                        onChange={(event) =>
                            setFormData({ ...formData, approval_variant: event.target.value })
                        }>
            ...
            <Box display='flex' justifyContent='space-between' alignItems='center' flexWrap='wrap' mb='20px'>
                <FormControl w='31%'>
                    <FormLabel >
                        P-tax Variant
                    </FormLabel>
                ...
                <FormControl w='31%'>
                    ...
                    <Checkbox onChange={(event) =>
                        setFormData({ ...formData, hod: event.target.checked ? 1 : 0 })
                    } colorScheme='red' size='lg' value={formData.hod}>
                        Checkbox
                    </Checkbox>
                </FormControl>
            </Box>
