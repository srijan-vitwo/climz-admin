    ...
    return (
        <>
            <Heading w="100%" fontWeight="600" mb="2%" color='claimzTextBlueColor'>
                <Box as='span' pr='15px'><i className="fa-solid fa-building"></i></Box> Bank Details
            </Heading>
            <Box display='flex'
                flexWrap='wrap'
            ...
            >
                <FormControl w='24%'>
                    <FormLabel>
                        Bank Name <Box as='span' color='orange'>*</Box>
                    </FormLabel>
                ...
                <FormControl w='24%'>
                    ...
                    <Input type='text' placeholder='Bank Account No'
                        ...
                        onChange={(event) =>
                            setFormData({ ...formData, bank_account_no: event.target.value })
                        } />
                </FormControl>
                ...
                <FormControl w='24%'>
                    ...
                    <Input type='text' placeholder='IFSC code'
                        ...
                        onChange={(event) =>
                            setFormData({ ...formData, ifsc_code: event.target.value })
                        } />
                </FormControl>
            </Box>
        </>
