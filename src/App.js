        ...
        <Route element={<Privetroute />}>
          ...
          <Route path="/master-setting" element={<MasterSetting />} >
            <Route path="attendance-settings" element={<AttendanceSettings />} >
              ...
              <Route path="holiday-policies" element={<HolidayPolicies />} />
              <Route path="track-managment" element={<TrackManagement />} />
            </Route>
            <Route path="conveyance-policies" element={<ConveyancePolicies />} />
            <Route path="add-tarvel-mode" element={<AddTravelMode />} />
            <Route path="manage-company" element={<ManageCompany />} >
              ...
              <Route path="grade-setting" element={<GradeSetting />} />
              <Route path="designation-setting" element={<Designation />} />
            </Route>
            <Route path="add-department" element={<AddDepartment />} />
            <Route path="add-new-type" element={<AddNewType />} />
            <Route path="add-new-travel-master" element={<AddNewTravelMaster />} />
            <Route path="add-new-region" element={<AddNewRegion />} />
            <Route path="create-new-employee" element={<MultiStepForm />} />
            <Route path="submited" element={<Formsubmited />} />
            <Route path="payroll-details" element={<PayrollDetails />} />
            <Route path="salary-details/:empid" element={<SalaryDetails />} />
            <Route path="payslip-details/:empid" element={<PayslipList />} />
          ...
          <Route path="manage-employee" element={<ManageEmployee />} >
            ...
            <Route path="probation-employee" element={<ProbationEmployee />} />
            <Route path="separation-employee" element={<SeparationEmployee />} />
            <Route path="notice-period-employee" element={<NoticePeriodEmployee />} />
          </Route>
          <Route path="onboarding-candidate" element={<OnboardingCandidate />} />
          <Route path="/reports" element={<Reports />} >
            <Route path="monthly-attendance-report" element={<AttendanceReportView />} />
            <Route path="employee-attendance" element={<EmployeeAttendancReportView />} />
            <Route path="all-employee-attendance" element={<AllEmployeeAttendanceReportView />} />
            <Route path="monthly-salary-report" element={<SalaryReportView />} />
            <Route path="department-wise-salary-report" element={<DepartmentWiseSalaryReportView />} />
            <Route path="all-employee-payroll" element={<AllPayrollReportView />} />
            {/* <Route path="company-wise-salary-report" element={<CompanyWiseSalaryReportView />} /> */}
            <Route path="employee-designation-wise-diversity-report" element={<EmpGroupWiseDiversityReportView />} />
            <Route path="employee-grade-wise-diversity-report" element={<EmpGradeWiseDiversityReportView />} />
            <Route path="employee-gender-wise-diversity-report" element={<EmpGenderWiseDiversityReportView />} />
            <Route path="employee-age-wise-diversity-report" element={<EmpAgeWiseDiversityReportView />} />
            <Route path="employee-joining-date-wise-diversity-report" element={<EmpJoiningDateWiseDiversityReportView />} />
            <Route path="employee-age-wise-attrition-report" element={<EmpAgeWiseAttritionReportView />} />
            <Route path="employee-gender-wise-attrition-report" element={<EmpGenderWiseAttritionReportView />} />
            <Route path="month-wise-attrition-report" element={<MonthWiseAttritionReportView />} />
          </Route>
          <Route path="/profile" element={<Profile />} />
          <Route path="/shift-management" element={<ShiftManagement />}>
            <Route path="add-shift-management" element={<ShiftAdd />} />
